...
#define TCLCURL_OPTION_LIST(X) \
    ...
    X(TCLCURLOPT_POSTFIELDS, "CURLOPT_POSTFIELDS", "-postfields", TclCurl_HandleSetoptChar, CURLOPT_COPYPOSTFIELDS, NULL) \
    X(TCLCURLOPT_POSTFIELDSIZE_LARGE, "CURLOPT_POSTFIELDSIZE_LARGE", "-postfieldsize", TclCurl_HandleSetoptCurlOffT, CURLOPT_POSTFIELDSIZE_LARGE, NULL) \
    ...
    X(TCLCURLOPT_KRB4LEVEL, "CURLOPT_KRB4LEVEL", "-krb4level", TclCurl_HandleSetoptChar, CURLOPT_KRBLEVEL, NULL) \
    ...
    X(TCLCURLOPT_KRBLEVEL, "CURLOPT_KRBLEVEL", "-krblevel", TclCurl_HandleSetoptChar, CURLOPT_KRBLEVEL, NULL) \
    ...
    X(TCLCURLOPT_SOCKS5_GSSAPI_SERVICE, "CURLOPT_SOCKS5_GSSAPI_SERVICE", "-socks5gssapiservice", TclCurl_HandleSetoptChar, CURLOPT_SOCKS5_GSSAPI_SERVICE, NULL) \
    ...
    X(TCLCURLOPT_PROTOCOLS, "CURLOPT_PROTOCOLS", "-protocols", TclCurl_HandleProtocolMask, CURLOPT_PROTOCOLS, NULL) \
    X(TCLCURLOPT_REDIR_PROTOCOLS, "CURLOPT_REDIR_PROTOCOLS", "-redirprotocols", TclCurl_HandleProtocolMask, CURLOPT_REDIR_PROTOCOLS, NULL) \
